...
export class passwordReset1678841018219 implements MigrationInterface {
  name = 'passwordReset1678841018219';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`avaliacao\` CHANGE \`avaliador_id\` \`avaliador_id\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`avaliacao\` CHANGE \`avaliado_id\` \`avaliado_id\` int NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`avaliacao\` CHANGE \`avaliado_id\` \`avaliado_id\` int NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`avaliacao\` CHANGE \`avaliador_id\` \`avaliador_id\` int NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`avaliacao\` ADD CONSTRAINT \`FK_945ad0f9f6b9e6cff592e7c6e40\` FOREIGN KEY (\`avaliado_id\`) REFERENCES \`usuario_api\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
