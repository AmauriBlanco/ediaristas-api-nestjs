...
export class $npmConfigName1676585748140 implements MigrationInterface {
  name = '$npmConfigName1676585748140';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`avaliacao\` (\`id\` int NOT NULL AUTO_INCREMENT, \`descricao\` varchar(255) NOT NULL, \`nota\` int NOT NULL, \`visibilidade\` tinyint NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`on_update\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`diaria_id\` int NOT NULL, \`avaliador_id\` int NULL, \`avaliado_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `ALTER TABLE \`endereco_diarista\` CHANGE \`complemento\` \`complemento\` varchar(255) NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`usuario_api\` CHANGE \`endereco_id\` \`endereco_id\` int NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`usuario_api\` CHANGE \`endereco_id\` \`endereco_id\` int NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`endereco_diarista\` CHANGE \`complemento\` \`complemento\` varchar(255) NULL DEFAULT 'NULL'`,
    );
